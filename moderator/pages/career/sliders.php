<div class="maincontent">
    ...
    <div class="wrap_form">
        ...
        <div class="wrapbutton alignright">
          <div class="new_row button" id="newrow" onClick="location.href='?page=career&section=new';">Tambah Karir</div>
        </div>
        <div class="row_group_input">
            <table class="dataTable" width="100%" border="1" id="dataTable_career">
              ...
              <tbody>
                <?php 
                    $tabslider = mysqli_query($dbconnect,"SELECT id,title FROM page_career");
                ...
                ?>
                  <tr>
                    ...
                    <td class="aligncenter">
                      <a href="?page=career&section=edit&id=<?php echo $dataslide["id"]; ?>" title="Edit">
