...
<div class="maincontent">
	<div class="some_input">
      <?php 
          $getDesc = mysqli_query($dbconnect,"SELECT id,label_page,content FROM desc_page WHERE label_page='feature'");
      ...
      ?>
        ...
        <div class="submitarea relative">
          ...
          <div class="bag_submit"><input type="submit" value="Simpan" onclick="savedesc('feature');"></div> 
